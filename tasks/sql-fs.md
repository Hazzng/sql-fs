...
just-bash provides a virtual bash interpreter with an in-memory filesystem (`InMemoryFs`). SQL-FS extends this with:
...
aca.yaml
tasks/
  prd-sql-fs-api.md  <- full PRD with 105 user stories
  sql-fs.md            <- this file
```

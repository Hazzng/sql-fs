# VirtualFS Python SDK — Setup & Auth

## Install

The SDK lives at `clients/python/` in the virtualfs monorepo and is published as
the `virtualfs` package on PyPI (see `pyproject.toml` for the canonical version).
